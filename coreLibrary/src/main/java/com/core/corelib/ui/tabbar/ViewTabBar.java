 ...
 */
public class ViewTabBar extends HorizontalScrollView {
    
    private static final int TAG_POSITION_KEY = 0XFFFFFF;
...
//    private int tabBackgroundResId;
    ...
    public ViewTabBar(Context context) {
        this(context, null);
    }

    public ViewTabBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ViewTabBar(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (pager.getAdapter() instanceof ViewTabProvider) {
                View view = ((ViewTabProvider) pager.getAdapter()).getSelectTabView(i, getSelectTabView(i));
...
//        v.setBackgroundResource(tabBackgroundResId);
    ...
    class PageOnClickListener implements OnClickListener{
        ...
        public void onClick(View view) {
            int tag = (int)view.getTag(TAG_POSITION_KEY);
            scrollToChild(tag, 0);
    ...
    public void setSelectItem(int position){
        ...
        for (int i = 0; i < tabsContainer.getChildCount(); i++) {
            ...
            if (i == position) {
                view = ((ViewTabProvider) pager.getAdapter()).getSelectTabView(i, getSelectTabView(i));
                setSelectTabView(i, view);

            } else {
                view = ((ViewTabProvider) pager.getAdapter()).getDisSelectTabView(i, getDisSelectTabView(i));
                setDisSelectTabView(i, view);
            }

            view.setTag(TAG_POSITION_KEY, i);
