...
public class LoadingCD extends View {
    ...
    public LoadingCD(Context context) {
        this(context, null);
    }

    public LoadingCD(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LoadingCD(Context context, AttributeSet attrs, int defStyleAttr) {
