package com.core.corelib.ui.tabbar;
...
import com.core.corelib.ui.tabbar.assist.Margins;
...
public class TabBar extends HorizontalScrollView {
    ...
    public interface IconTextTabProvider<T extends Object> extends TextTabProvider{
        public T getTabIcon(int position);
        public T getTabSelectIcon(int position);
        public Rect getTabIconBounds(int position);
    }

    public interface ViewTextTabProvider extends TextTabProvider{
        public View getTabSelectView(int position, View view, ViewGroup parent);
        public View getTabView(int position, View view, ViewGroup parent);
    }
...
//    private int tabBackgroundResId;
    ...
    public TabBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        indicatorColor = a.getColor(R.styleable.TabBar_tabBarIndicatorColor, indicatorColor);
        underlineColor = a.getColor(R.styleable.TabBar_tabUnderlineColor, underlineColor);
        dividerColor = a.getColor(R.styleable.TabBar_tabDividerColor, dividerColor);
        indicatorHeight = a.getDimensionPixelSize(R.styleable.TabBar_tabBarIndicatorHeight, indicatorHeight);
        underlineHeight = a.getDimensionPixelSize(R.styleable.TabBar_tabUnderlineHeight, underlineHeight);
        dividerPadding = a.getDimensionPixelSize(R.styleable.TabBar_tabDividerPadding, dividerPadding);
        tabPadding = a.getDimensionPixelSize(R.styleable.TabBar_tabPaddingLeftRight, tabPadding);
        tabPaddingTopBottom = a.getDimensionPixelSize(R.styleable.TabBar_tabPaddingTopBottom, tabPaddingTopBottom);
//        tabBackgroundResId = a.getResourceId(R.styleable.AdvancedPagerSlidingTabStrip_apTabBackground, tabBackgroundResId);
        tabBackgroundColor = a.getColor(R.styleable.TabBar_tabBackgroundColor, tabBackgroundColor);
        shouldExpand = a.getBoolean(R.styleable.TabBar_tabShouldExpand, shouldExpand);
        scrollOffset = a.getDimensionPixelSize(R.styleable.TabBar_tabScrollOffset, scrollOffset);
        textAllCaps = a.getBoolean(R.styleable.TabBar_tabTextAllCaps, textAllCaps);
        // TODO: 16/3/14
        tabTextColor = a.getColor(R.styleable.TabBar_tabItemTextColor, tabTextColor);
        tabTextSelectColor = a.getColor(R.styleable.TabBar_tabItemTextSelectColor, tabTextSelectColor);
        tabDrawMode = a.getInteger(R.styleable.TabBar_tabDrawMode,DRAW_MODE_NORMAL);
...
//        defaultTabLayoutParams = new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.MATCH_PARENT);
    ...
    public void notifyDataSetChanged() {
        ...
        if (!(pager.getAdapter() instanceof TextTabProvider)) {
            return;
        }

        tabsContainer.removeAllViews();

        tabCount = ((TextTabProvider) pager.getAdapter()).getTabCount();

        for (int i = 0; i < tabCount; i++) {

            if (pager.getAdapter() instanceof IconTextTabProvider) {

                addIconTab(i, ((IconTextTabProvider) pager.getAdapter()).getTabIcon(i), ((IconTextTabProvider) pager.getAdapter()).getTabTitle(i).toString());

            } else if(pager.getAdapter() instanceof ViewTextTabProvider){

                addViewTab(i, ((ViewTextTabProvider) pager.getAdapter()), ((IconTextTabProvider) pager.getAdapter()).getTabTitle(i).toString());

            } else if (pager.getAdapter() instanceof TextTabProvider){

                addTextTab(i, ((IconTextTabProvider) pager.getAdapter()).getTabTitle(i).toString());

            }

//            if (pager.getAdapter() instanceof IconTextTabProvider) {
//                addIconTab(i, ((IconTextTabProvider) pager.getAdapter()).getTabIcon(i), pager.getAdapter().getPageTitle(i).toString());
//            } else if(pager.getAdapter() instanceof ViewTextTabProvider){
//                addViewTab(i, ((ViewTextTabProvider) pager.getAdapter()),pager.getAdapter().getPageTitle(i).toString());
//            } else {
...
//        txtParams.addRule(RelativeLayout.CENTER_IN_PARENT);
        ...
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(getResources().getDimensionPixelSize(R.dimen.tab_dot_width_height), getResources().getDimensionPixelSize(R.dimen.tab_dot_width_height));
        TextView dot = new TextView(getContext());
        dot.setTextColor(Color.WHITE);
        dot.setBackgroundColor(Color.BLUE);
        dot.setGravity(Gravity.CENTER);
        dot.setSingleLine();
        dot.setTextSize(TypedValue.COMPLEX_UNIT_PX, getResources().getDimensionPixelSize(R.dimen.tab_dot_text_size));
        //16 new
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            dot.setBackground(ResourcesCompat.getDrawable(getResources(), R.drawable.shape_tab_dot, null));
        }else{
            dot.setBackgroundDrawable(ResourcesCompat.getDrawable(getResources(), R.drawable.shape_tab_dot, null));
        }
        layoutParams.addRule(RelativeLayout.ALIGN_PARENT_RIGHT);
        layoutParams.setMargins(0, getResources().getDimensionPixelSize(R.dimen.tab_dot_margin_top), getResources().getDimensionPixelSize(R.dimen.tab_dot_margin_right), 0);
    ...
    public void showDot(int index) {
        ...
        layoutParams.width = getResources().getDimensionPixelSize(R.dimen.tab_dot_width_height);
        layoutParams.height = getResources().getDimensionPixelSize(R.dimen.tab_dot_width_height);
    ...
    private void addViewTab(final int position, ViewTextTabProvider provider, String title) {
...
//        txt.setId(R.id.id_tab_txt);
        ...
        //使用缓存
        View view = provider.getTabView(position, getTabView(position), tab);
...
//        viewLayoutParams.addRule(RelativeLayout.ABOVE, R.id.id_tab_txt);
        ...
        layoutParams.addRule(RelativeLayout.ALIGN_PARENT_RIGHT);
        layoutParams.setMargins(0, 0, getResources().getDimensionPixelSize(R.dimen.tab_dot_margin_right), 0);
...
//            v.setBackgroundResource(tabBackgroundResId);
    ...
    private void setViewResource(int position ,Object obj , TextView view){
        IconTextTabProvider iconTextTabProvider = (IconTextTabProvider)pager.getAdapter();
        Rect rect = iconTextTabProvider.getTabIconBounds(position);
    ...
    public void setSelectItem(int position){
        for (int i = 0; i < tabsContainer.getChildCount(); i++) {
            ...
            if (i == position) {
                ...
                if (pager.getAdapter() instanceof IconTextTabProvider) {
                    Object obj = ((IconTextTabProvider) pager.getAdapter()).getTabSelectIcon(i);
...
//                    ().setCompoundDrawablesWithIntrinsicBounds(0, ((IconTabProvider) pager.getAdapter()).getPageIconSelectResId(i), 0, 0);
                    ...
                    View view = ((ViewTextTabProvider) pager.getAdapter()).getTabSelectView(i, getTabView(i), linearLayout);
                    setTabView(i,view);
                }
//                    ((TextView) linearLayout.getChildAt(0)).setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.home_categry_icon_f_n, 0, 0);
                ...
                if (pager.getAdapter() instanceof IconTextTabProvider) {
                    Object obj = ((IconTextTabProvider) pager.getAdapter()).getTabIcon(i);
                    setViewResource(position, obj, (TextView) linearLayout.getChildAt(0));
//                    ((TextView) linearLayout.getChildAt(0)).setCompoundDrawablesWithIntrinsicBounds(0, ((IconTabProvider) pager.getAdapter()).getPageIconResId(i), 0, 0);
                    ...
                    View view = ((ViewTextTabProvider) pager.getAdapter()).getTabView(i, getTabView(i), linearLayout);
                    setTabView(i,view);
                }
//                    ((TextView) linearLayout.getChildAt(0)).setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.home_categry_icon_n, 0, 0);
    ...
    public void setTextSelectColor(int textSelectColor) {
        this.tabTextSelectColor = textSelectColor;
        updateTabStyles();
    }
