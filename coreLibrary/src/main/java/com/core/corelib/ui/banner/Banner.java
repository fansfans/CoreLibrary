package com.core.corelib.ui.banner;
...
import com.core.corelib.ui.banner.adapter.BannerPageAdapter;
import com.core.corelib.ui.banner.holder.BannerViewHolderCreator;
import com.core.corelib.ui.banner.listener.BannerPageChangeListener;
import com.core.corelib.ui.banner.listener.OnItemClickListener;
import com.core.corelib.ui.banner.scoller.ViewPagerScroller;
import com.core.corelib.ui.banner.view.BannerLoopViewPager;
...
//        a.recycle();
    ...
    private void init(Context context) {
        View hView = LayoutInflater.from(context).inflate(
                R.layout.lib_banner_viewpager_layout, this, true);
    ...
    static class AdSwitchTask implements Runnable {
        ...
        AdSwitchTask(Banner convenientBanner) {
            this.reference = new WeakReference<Banner>(convenientBanner);
        }
    ...
    public Banner setPages(BannerViewHolderCreator holderCreator,List<T> datas){
        this.mDatas = datas;
        pageAdapter = new BannerPageAdapter(holderCreator,mDatas);
    ...
    public void setRatio(int widthPrecent, int heightPercent) {
        ratio = (widthPrecent * 1.0f)/heightPercent;
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthMode == MeasureSpec.EXACTLY && ratio != 0.0f && heightMode != MeasureSpec.EXACTLY) {
            height = (int)(width / ratio + 0.5);
            heightMeasureSpec = MeasureSpec.makeMeasureSpec(height, MeasureSpec.EXACTLY);
        } else if (heightMode == MeasureSpec.EXACTLY && ratio != 0.0f && widthMode != MeasureSpec.EXACTLY) {
