package com.core.corelib.ui.richedit;
...
import com.core.corelib.ui.richedit.assist.DataImageView;
import com.core.corelib.ui.richedit.assist.DeletableEditText;
...
public class RichTextEditor extends ScrollView {
	...
	private EditText createEditText(String hint, int paddingTop) {
		...
		editText.setLineSpacing(dip2px(10), 1.0f);
		editText.setTextColor(Color.BLACK);
		// added by myself end


//		EditText editText = (EditText) inflater.inflate(R.layout.lib_edit_item,
//				null);
	...
	private RelativeLayout createImageLayout() {
		...
		imageView.setImageResource(R.drawable.ic_lib_close);
		imageView.setScaleType(ImageView.ScaleType.CENTER_INSIDE);

		ViewGroup.LayoutParams params =
				new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);

		RelativeLayout.LayoutParams imageViewParams = new RelativeLayout.LayoutParams(dip2px(50), dip2px(50));
		imageViewParams.addRule(RelativeLayout.ALIGN_PARENT_RIGHT | RelativeLayout.ALIGN_PARENT_TOP);

		layout.setLayoutParams(params);
		layout.addView(dataImageView, params);
		layout.addView(imageView, imageViewParams);
		// added by myself end


//		RelativeLayout layout = (RelativeLayout) inflater.inflate(
//				R.layout.lib_edit_imageview, null);
		layout.setTag(viewTagIndex++);
//		View imageView = layout.findViewById(R.id.image_close);
	...
	private void addEditTextAtIndex(final int index, String editStr) {
		EditText editText2 = createEditText("", editNormalPadding);
//				getResources()
//				.getDimensionPixelSize(R.dimen.edit_padding_top));
	...
	private void addImageViewAtIndex(final int index, Bitmap bmp,
		...
		DataImageView imageView = (DataImageView) imageLayout.getChildAt(1);
	...
	public List<EditData> buildEditData() {
		...
		for (int index = 0; index < num; index++) {
			...
			if (itemView instanceof EditText) {
				...
				DataImageView item = (DataImageView) ((RelativeLayout) itemView).getChildAt(1);
