...
public class LoadingDotsJump extends View {
    ...
    public LoadingDotsJump(Context context) {
        this(context, null);
    }

    public LoadingDotsJump(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LoadingDotsJump(Context context, AttributeSet attrs, int defStyleAttr) {
