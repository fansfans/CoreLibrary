...
public class LoadingPlayBall extends View {
    ...
    public LoadingPlayBall(Context context) {

        this(context, null);
    }

    public LoadingPlayBall(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LoadingPlayBall(Context context, AttributeSet attrs, int defStyleAttr) {
