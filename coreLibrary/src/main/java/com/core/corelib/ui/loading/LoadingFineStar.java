package com.core.corelib.ui.loading;
...
public class LoadingFineStar extends View {
    ...
    public LoadingFineStar(Context context) {
        this(context, null);
    }

    public LoadingFineStar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LoadingFineStar(Context context, AttributeSet attrs, int defStyleAttr) {
