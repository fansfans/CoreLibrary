...
public class LoadingSun extends View {
    ...
    public LoadingSun(Context context) {
        this(context, null);
    }

    public LoadingSun(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LoadingSun(Context context, AttributeSet attrs, int defStyleAttr) {
