...
public class LoadingBattery extends View {
    ...
    public LoadingBattery(Context context) {
        this(context, null);
    }

    public LoadingBattery(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LoadingBattery(Context context, AttributeSet attrs, int defStyleAttr) {
