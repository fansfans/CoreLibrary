...
public class LoadingDotsZoom extends View {
    ...
    public LoadingDotsZoom(Context context) {
        this(context, null);
    }

    public LoadingDotsZoom(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LoadingDotsZoom(Context context, AttributeSet attrs, int defStyleAttr) {
