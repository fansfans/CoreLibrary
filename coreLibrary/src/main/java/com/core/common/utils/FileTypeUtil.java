...
public class FileTypeUtil {
    ...
    public static final int FILE_TYPE_PPT     = 46;
    public static final int FILE_TYPE_PPTX    = 47;
    public static final int FILE_TYPE_XLS     = 48;
    public static final int FILE_TYPE_XLSX     = 49;
    public static final int FILE_TYPE_PDF     = 50;
    private static final int FIRST_PLAYLIST_FILE_TYPE = FILE_TYPE_M3U;
    private static final int LAST_PLAYLIST_FILE_TYPE = FILE_TYPE_PDF;
...
//            return null;
        ...
        return sFileTypeMap.get(extension.toUpperCase());
    }
    ...
    public static String getFileTypeCharsquence(String path) {
        if (isAudioFileType(path)) {
            return "audio";
        }
        if (isVideoFileType(path)) {
            return "video";
        }
        if (isPlayListFileType(path)) {
            return "playlist";
        }
