 ...
 */
package com.core.common.io;

import android.os.Build;

import com.core.common.io.stream.ByteArrayOutputStream;
import com.core.common.io.stream.StringBuilderWriter;
...
public class IOUtils {
    ...
    public static InputStream toInputStream(String input, Charset encoding) {
        return new ByteArrayInputStream(StringUtils.getBytes(input, Charsets.toCharset(encoding)));
    }
    ...
    public static InputStream toInputStream(String input, String encoding) throws IOException {
        byte[] bytes = StringUtils.getBytes(input, Charsets.toCharset(encoding));
    ...
    public static void write(char[] data, OutputStream output, Charset encoding) throws IOException {
        if (data != null) {
            output.write(StringUtils.getBytes(new String(data), Charsets.toCharset(encoding)));
        }
    }
    ...
    public static void write(String data, OutputStream output, Charset encoding) throws IOException {
        if (data != null) {
            output.write(StringUtils.getBytes(data, Charsets.toCharset(encoding)));
        }
    }
    ...
    public static void write(StringBuffer data, OutputStream output, String encoding) throws IOException {
        if (data != null) {
            output.write(StringUtils.getBytes(data.toString(), Charsets.toCharset(encoding)));
        }
    }
    ...
    public static void writeLines(Collection<?> lines, String lineEnding, OutputStream output, Charset encoding)
        ...
        for (Object line : lines) {
            if (line != null) {
                output.write(StringUtils.getBytes(line.toString(), cs));
            }
            output.write(StringUtils.getBytes(lineEnding, cs));
        }
    }
